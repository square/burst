 ...
 * to name your tests through the {@link org.robolectric.ParameterizedRobolectricTestRunner.Parameters#name()} property.
 *
 * @author John Ferlisi
 * @see Parameterized
 */
public final class ParameterizedRobolectricTestRunner extends Suite {
  ...
  public @interface Parameters {
     ...
     *
     * @return {@link java.text.MessageFormat} pattern string, except the index placeholder.
